...
{
    public partial class Quota : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["sourceData"] != null)
                {
                    ...
                    {
                        string KinesisQuotaUrl = string.Format(ConfigurationManager.AppSettings["KinesisQuotaUrl"], sessKey);
                        Response.Redirect(KinesisQuotaUrl);
                    }
                }
            }
            catch (Exception ex)
